...
hookfunction(messagebox,function()end)
setreadonly(syn, true)
_G.AIMTOOL = 'q'
_G.WEBHOOK_URL = 'PUT WEBHOOK URL HERE IF YOU WANT TO USE WEBHOOK MODE'
loadstring(game:HttpGet('https://raw.githubusercontent.com/dahubgamepro123/pornografia/main/legit'))()
